...
async function readState(store) {
  ...
  return existing && typeof existing === 'object'
    ? { sponsors: existing.sponsors || {}, speakers: existing.speakers || {}, delegates: existing.delegates || {}, seen: existing.seen || {}, notes: existing.notes || {} }
    : { sponsors: {}, speakers: {}, delegates: {}, seen: {}, notes: {} };
}
