...
const PROPS = ['firstname','lastname','email','jobtitle','company','associatedcompanyid','dietary_requirements','accessibility_requirements','pas_scan_id','createdate'];
...
const shape = (r, names) => {
  ...
  return {
    id: r.id,
    scanId: p.pas_scan_id || '',
    addedAt: p.createdate || '',
