// =============================================================
// GET /api/attendees            -> summary counts for every event
// GET /api/attendees?event=<id> -> full confirmed-attendee list
// -------------------------------------------------------------
// "Confirmed attendee" = a HubSpot contact whose `joining_instructions`
// multi-select CONTAINS the event's JI code (i.e. their JI is signed).
// Approvals/rejections are handled by marketing inside HubSpot; this
// endpoint only ever READS.
//
// Fields returned per delegate:
//   Record ID, First name, Last name, Email, Company (primary
//   associated company), Job title, Dietary requirements,
//   Accessibility requirements, Type ("Delegate").
// =============================================================
...
// Resolve primary associated company names in bulk: {id -> name}
...
// Page through every contact holding this event's JI code.
